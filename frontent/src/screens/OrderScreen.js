        ...
        <Col md={4}>
          <Card>
            <ListGroup variant='flush'>
              ...
              <ListGroup.Item style={{height:"200px",float:"center",backgroundColor:"white",margin:0}}>
                <Row>
                  <Col><img src={UPI(order.totalPrice,"7498233875@axl","Radheshyam Patil",200)} alt="UPI Image"/> </Col>
                </Row>
              </ListGroup.Item>
